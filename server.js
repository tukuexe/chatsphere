...
const CONFIG = {
    ...
    // App Settings
    APP_NAME: "ChatSphere",
    APP_URL: "https://chatsphere-1-5koy.onrender.com",
...
// ==================== INITIALIZATION ====================
// FIX: Use webhook instead of polling to avoid conflicts
let bot;
try {
...
function setupTelegramBot() {
    ...
    // Only setup commands, no polling to avoid conflicts
    if (bot) {
        bot.setMyCommands([
            { command: 'start', description: 'Start the bot' },
            { command: 'stats', description: 'Get chat statistics' },
